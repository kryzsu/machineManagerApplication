...
export class RawmaterialComponent implements OnInit {
  ...
  trackId(index: number, item: IRawmaterial): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IRawmaterial[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
