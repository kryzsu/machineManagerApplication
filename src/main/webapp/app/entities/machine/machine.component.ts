...
export class MachineComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.machineService
      ...
      .subscribe(
        (res: HttpResponse<IMachine[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInMachines(): void {
    this.eventSubscriber = this.eventManager.subscribe('machineListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMachine[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
